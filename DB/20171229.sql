...
ELSE
	...
	ELSE
		...
		ELSE
			...
			PREPARE STMT FROM "SELECT a.idasistencia,a.ingreso AS 'Fecha/Hora Ingreso',a.salida AS 'Fecha/Hora Salida',c.nombrepunto AS 'Punto',CONCAT(b.apellido,', ',b.nombre) AS 'Persona',b.aptomedico AS 'Aptitud Medica',d.tipopersona AS 'Tipo Persona'
				...
				SET @pag = _pag; 
				SET @cantfil = _cantfil; 
				EXECUTE STMT USING @fechaini,@fechafin,@tipopersona,@apellido,@nombre,@punto,@pag,@cantfil;
				DEALLOCATE PREPARE STMT;
			ELSE
