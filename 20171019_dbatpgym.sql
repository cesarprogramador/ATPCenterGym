...
MySQL - 5.7.13-log : Database - dbatpgym
*********************************************************************
*/
...
(17,'2017-09-26 11:47:51','0','500','Pago de cuota',59,'N','2017-09-26 11:47:51',1,1,0),
(18,'2017-09-26 11:49:05','0','250','Pago de cuota',60,'N','2017-09-26 11:49:05',1,1,0);
...
(61,23,'2017-11-26',NULL,'500',NULL,'250','N','2017-09-26 11:49:05',1,3,1);
...
(28,'desd','wind','1981-08-01','4444','52','78','45','fof@ww','dosde',45,'7','8d',2,2,NULL,NULL,NULL,NULL,NULL,'...','N','2017-08-22 01:55:48',1,1,NULL,NULL,NULL),
...
(50,'','proveedores 1','0000-00-00','','','1','1','prov@ddd,com','khjkjh',45,'45','54',NULL,NULL,'ape con','nombre con','contacto@co.com','4477','7777','','N','2017-10-05 01:23:43',1,1,NULL,NULL,'1234prov1'),
(51,'','proveedores 1','0000-00-00','','','1','1','prov@ddd,com','khjkjh',45,'45','54',NULL,NULL,'ape con','nombre con','contacto@co.com','4477','7777','','N','2017-10-05 01:23:43',1,1,NULL,NULL,'1234prov1'),
(52,'','proveedores 1','0000-00-00','','','1','1','prov@ddd,com','khjkjh',45,'45','54',NULL,NULL,'ape con','nombre con','contacto@co.com','4477','7777','','N','2017-10-05 01:23:43',1,1,NULL,NULL,'1234prov1'),
...
BEGIN
if (_idcurso<=0) then
	PREPARE STMT FROM "SELECT b.idcurso,c.nombrepunto as Punto,e.tipodeclase as Tipos,d.nombreclase as Clase,CONCAT('$ ',f.montocuota) as Cuota,f.idcuota,f.fechapago
